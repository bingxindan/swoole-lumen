...
class Connection implements ConnectionInterface
{
    ...
    public function beginTransaction()
    {
        ...
        ++$this->transactions;
        //事务开启标识
        ConstantHelper::createConst('BEGIN_TRANSACTION', 'start');
    ...
    public function commit()
    {
        ...
        //事务结束标识
        ConstantHelper::createConst('BEGIN_TRANSACTION', 'cend');
    ...
    public function rollBack()
    {
        ...
        $this->transactions = max(0, $this->transactions - 1);
        //事务结束标识
        ConstantHelper::createConst('BEGIN_TRANSACTION', 'rend');
    ...
    public function logQuery($query, $bindings, $time = null)
    {
        ...
        SqlLog::add($query, $bindings, $time, $host);
